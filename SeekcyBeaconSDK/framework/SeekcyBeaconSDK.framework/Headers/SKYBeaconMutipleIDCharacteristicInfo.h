 ...
 *
 */
- (instancetype)initWithcharacteristicID:(NSString *)characteristicID uuid:(NSString *)uuid major:(NSString *)major minor:(NSString *)minor txPower:(NSString *)txPower measuredPower:(NSString *)measuredPower isEncrypted:(BOOL)isEncrypted;
@end
