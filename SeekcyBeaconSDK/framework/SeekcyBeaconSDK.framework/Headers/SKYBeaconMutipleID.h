 ...
 *  @property lockedKey
 *
 *  @discussion 开启防窜改模式时设置的key值,开启防窜改后，所有写入动作都会使用这个key，否则使用寻息提供的默认key。
 *
 */
...
/*!
 *  @property multiMACFlag/Users/seekcy/Downloads/SKYBeaconSDK/src/com/skybeacon/sdk/locate/SKYBeaconMultiIDs.java
 *
